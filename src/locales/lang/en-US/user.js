export default {
  'user.login.username.placeholder': 'Account: Disney',
  'user.login.password.placeholder': 'password: forever25',
  'user.login.acc.placeholder.admin':'Account: Violet',
  'user.login.psw.placeholder.admin':'password: forever25',
  ...
  'user.login.tab-login-credentials': 'User Login',
  'user.login.tab-login-mobile': 'Admin Login',
