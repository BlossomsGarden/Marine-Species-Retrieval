    ...
    <a-card :bordered="false" class="ant-pro-components-tag-select">
      <a-form :form="form" layout="inline">
        <standard-form-row title="界" block style="padding-bottom: 11px;" class="my-center">
          <a-form-item>
            <tag-select>
              <tag-select-option value="Category1">植物界</tag-select-option>
              <tag-select-option value="Category2">动物界</tag-select-option>
            </tag-select>
          </a-form-item>
        </standard-form-row>
        ...
        <standard-form-row title="木" block style="padding-bottom: 11px;" class="my-center">
          <a-form-item>
            <tag-select>
              <tag-select-option value="Category1">植物界</tag-select-option>
              <tag-select-option value="Category2">动物界</tag-select-option>
        ...
        <standard-form-row title="其它选项" grid last>
          <a-row>
            <a-col :lg="8" :md="10" :sm="10" :xs="24">
              <a-form-item :wrapper-col="{ sm: { span: 16 }, xs: { span: 24 } }" label="上传者">
                <a-select
            ...
            <a-col :lg="8" :md="10" :sm="10" :xs="24">
              <a-form-item label="物种名">
                <a-input placeholder="不限"/>
              </a-form-item>
            </a-col>
          </a-row>
        </standard-form-row>
